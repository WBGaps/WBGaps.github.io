...
export default [
  ...
  //   popoverDesc: "手机看或分享至朋友圈",
  // },
  {
    title: "星球",
    icon: "/icon/xingqiu.png",
    popoverTitle:
      '<span style="font-size:0.8rem;font-weight:bold;"><span style="color:red;">实际项目</span>、编程学习指导、学习资源、求职指南、技术分享、编程交流</span>',
    popoverUrl:
      "/qrcode-WBGaps.png",
    popoverDesc: "知识星球：WBGaps",
  },
  // {
  //   title: "交流群",
  //   icon: "/icon/weixin.png",
  //   popoverTitle:
  //     '<span style="font-size:0.8rem;font-weight:bold;">扫码添加 <span style="color:red;">微信</span>，拉你进专属学习交流群</span>',
  //   popoverUrl:
