...
WBGaps在这里对该项目做一个简单的介绍。

> 加入星球后，做项目如果遇到问题可以问WBGaps
...
带着WBGaps的项目去参赛，进了 C4 比赛（这里主要是项目给了小伙伴启发）：
...
除了这个项目外，WBGaps在星球中持续带领大家直播做新项目、分享项目开发经验和源码，欢迎加入。
